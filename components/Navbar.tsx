        ...
        <div className="flex items-center justify-between">
          ...
          >
            <Link href="/" className="flex items-center space-x-2 md:space-x-3">
              <div className={`${isSmallScreen ? 'w-10 h-10' : 'w-12 h-12'} bg-white rounded-full flex items-center justify-center overflow-hidden shadow-lg flex-shrink-0`}>
                <Image
                  src="/bva_logo.jpeg"
              ...
              <div className="text-white flex-shrink-0">
                ...
                <h3 className={`${isSmallScreen ? 'text-lg' : 'text-xl md:text-2xl'} font-bold leading-tight`}>
                  ...
                  <span className="text-white  px-1 rounded">Bikash</span>{' '}
          ...
          <div className="hidden md:block text-center">
            <div className="text-white font-semibold">
              ...
              <div className="text-2xl  font-bold" style={{ fontFamily: "'Noto Sans Odia', sans-serif" }}>
          ...
          <div className="hidden md:flex items-center space-x-4 lg:space-x-6">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg font-semibold transition-all duration-300 flex items-center space-x-2 whitespace-nowrap"
            >
              <span>📞</span>
              <span>7750006089</span>
            </motion.a>
          </div>
          ...
          <button
            ...
            className="md:hidden text-white text-2xl focus:outline-none flex-shrink-0 ml-2"
          >
