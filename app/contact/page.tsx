...
export default function ContactPage() {
  ...
  const contactInfo = [
  {
    ...
    details: ['7750006089'],
    link: 'tel:7750006089',
    color: 'from-violet-500 to-pink-500', // BVA tri-color
    type: 'bva' // Bharat Bikash Abhijan
  },  
  {
    icon: <FaWhatsapp />,
    title: 'WhatsApp',
    details: ['7750006089'],
    link: 'https://wa.me/917750006089',
    color: 'from-purple-500 to-violet-500', // BVA tri-color
    type: 'bva' // Bharat Bikash Abhijan
  },
  {
    icon: <FaPhone />,
    ...
    details: ['6371602387'],
    link: 'tel:6371602387',
    color: 'from-blue-500 to-cyan-500', // SEBA blue
    type: 'seba' // SEBA Enterprises
  },
  {
    icon: <FaWhatsapp />,
    title: 'WhatsApp',
    ...
    color: 'from-green-500 to-teal-500', // SEBA green
    type: 'seba' // SEBA Enterprises
  },
  {
    icon: <FaEnvelope />,
    ...
    color: 'from-red-500 to-pink-500', // Email red
    type: 'seba' // SEBA Enterprises
  },
  {
    icon: <FaMapMarkerAlt />,
    title: 'Address',
    details: ['Plot No.-629, Sahid Nagar, Bhubaneswar-751007, India'],
    link: '#',
    color: 'from-purple-500 to-indigo-500', // Address purple
    type: 'seba' // SEBA Enterprises
  },
  {
    icon: <FaClock />,
    ...
    link: '#',
    color: 'from-yellow-500 to-orange-500', // Working hours yellow-orange
    type: 'seba' // SEBA Enterprises
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <AnimatedSection>
          <div className="text-center mb-12">
            ...
            <p className="text-xl p-2 rounded bg-slate-500 text-white max-w-3xl mx-auto">
              Get in touch with{' '}
              {/* <div className="flex items-center justify-center space-x-1"> */}
                          <span className="text-orange-500 font-bold">Bharat{' '}</span>
                          <span className="text-white font-bold">Bikash{' '}</span>
                          <span className="text-green-500 font-bold">Abhijan</span>
                        {/* </div> */}
                  ...
                  <div className="mt-4">
                    {info.type === 'bva' ? (
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        {/* {info.details[0] === '7750006089' && (
                          <div className="text-xs text-white/80 text-center">Bharat Bikash Abhijan</div>
                        )} */}
                      </div>
                    ) : info.type === 'seba' ? (
                      // SEBA Enterprises - Normal display
